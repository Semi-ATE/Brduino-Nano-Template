 ...
 * Macro which should be defined as either zero (0) or one (1).
 *
 * To enable Device Firmware Monitor (DFM) calls, set to one (1).
 ******************************************************************************/
#define TRC_CFG_DFM_ENABLED 1

#if (TRC_CFG_DFM_ENABLED >= 1)

/*******************************************************************************
 * TRC_CFG_DFM_FIRMWARE_VERSION_MAX_LEN
 *
 * Macro which should be defined as an integer value.
 *
 * The maximum length (in bytes) for the firmware version string, the input to
 * function dfm_set_firmware_version, including the termination byte.
 ******************************************************************************/
#define TRC_CFG_DFM_FIRMWARE_VERSION_MAX_LEN 20

/*******************************************************************************
 * TRC_CFG_DFM_MAX_SYMPTOMS
 *
 * Macro which should be defined as an integer value.
 *
 * The maximum number of symptoms that can be added in one trace.
 *
 * Note: Each symptom will allocate 2 * 4 bytes, even if not set in the trace.
 ******************************************************************************/
#define TRC_CFG_DFM_MAX_SYMPTOMS 4
