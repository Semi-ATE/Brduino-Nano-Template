...
void USB_DeviceApplicationInit(void)
{
    ...
    {
        printf("USB device CDC virtual com initialized\r\n");
    ...
    printf("Dtarting USB device CDC virtual com ...\r\n");
    SDK_DelayAtLeastUs(5000, SDK_DEVICE_MAXIMUM_CPU_CLOCK_FREQUENCY);
    USB_DeviceRun(s_cdcVcom.deviceHandle);
    printf("... USB device CDC virtual com up and running\r\n");
}
   ...
   while (1)
   {
        if ((1 == s_cdcVcom.attach) && (1 == s_cdcVcom.startTransactions))
        {
            ...
            if (s_sendSize)
            {
                ...
                g_error = error = USB_DeviceCdcAcmSend(s_cdcVcom.cdcAcmHandle, USB_CDC_VCOM_BULK_IN_ENDPOINT, s_currSendBuf, size);
