...
class GET_CURR_WINDOWS(command_ABC):
    '''
    Description: A window is a set of upper and lower limits that determine if a rail is 
    considered OK or not. A measurement is considered OK if (after applying the appropriate 
    gain and offset) it is in the interval LLIM <= MEAS <= HLIM.
